...
public class TopDividendYieldStocks extends AppCompatActivity {
    ...
    int startingIndex = 60;

    int portfolioid=((startingIndex/10)+1);

    DatabaseClass db = new DatabaseClass(TopDividendYieldStocks.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btninvesting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog =new Dialog(TopDividendYieldStocks.this);
