...
public class BankUSAStocks extends AppCompatActivity {
    ...
    int startingIndex = 40;

    int portfolioid=((startingIndex/10)+1);

    DatabaseClass db = new DatabaseClass(BankUSAStocks.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btninvesting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog =new Dialog(BankUSAStocks.this);
