...
public class TopPERatioStocks extends AppCompatActivity {
    ...
    int startingIndex = 70;

    int portfolioid=((startingIndex/10)+1);

    DatabaseClass db = new DatabaseClass(TopPERatioStocks.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btninvesting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog =new Dialog(TopPERatioStocks.this);
