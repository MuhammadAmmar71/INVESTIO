...
public class AgricultureStocks extends AppCompatActivity {
    ...
    DatabaseClass db = new DatabaseClass(AgricultureStocks.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btninvesting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog =new Dialog(AgricultureStocks.this);
