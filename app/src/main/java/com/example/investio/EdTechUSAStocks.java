...
public class EdTechUSAStocks extends AppCompatActivity {
    ...
    DatabaseClass db = new DatabaseClass(EdTechUSAStocks.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btninvesting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog =new Dialog(EdTechUSAStocks.this);
