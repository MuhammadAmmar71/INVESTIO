...
public class TopPBRatioStocks extends AppCompatActivity {
    ...
    DatabaseClass db = new DatabaseClass(TopPBRatioStocks.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btninvesting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog =new Dialog(TopPBRatioStocks.this);
