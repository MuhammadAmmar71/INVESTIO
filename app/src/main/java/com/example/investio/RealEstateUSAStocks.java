...
public class RealEstateUSAStocks extends AppCompatActivity {
    ...
    int startingIndex = 30;

    int portfolioid=((startingIndex/10)+1);

    DatabaseClass db = new DatabaseClass(RealEstateUSAStocks.this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btninvesting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog =new Dialog(RealEstateUSAStocks.this);
